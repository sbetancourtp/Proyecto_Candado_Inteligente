...
Para realizar la parte de audio del proyecto principal, se nos dio la función de elaborar toda un módulo de audio basado en I2S el cual se muestra en la siguiente imagen.
